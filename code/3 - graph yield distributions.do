...
graph export "..\figures\yield_pred_`com'.png", replace width(2000)
...
twoway kdensity ln_yield_hat if year==1965 || kdensity ln_yield_hat if year==1975 || kdensity ln_yield_hat if year==1985 || ///
	kdensity ln_yield_hat if year==1995 || kdensity ln_yield_hat if year==2005 || kdensity ln_yield_hat if year==2015, ///
...
graph export "..\figures\lnyield_percentiles_`com'.png", replace width(2000)
...
graph export "..\figures\yield_percentiles_combined.png", replace width(2000)
...
graph export "..\figures\lnyield_percentiles_combined.png", replace width(2000)
...
reshape wide yield* lnyield*, i(year) j(commodity) string
